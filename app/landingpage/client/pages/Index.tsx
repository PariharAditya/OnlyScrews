        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen items-center gap-8 px-4 lg:px-8 py-12 lg:py-0">
          ...
          <div className="flex flex-col justify-center gap-6 py-12 lg:py-0 lg:pl-8">
            ...
            <div className="flex gap-4 flex-wrap pt-4">
              <button className="px-6 sm:px-8 py-2 sm:py-3 border-2 border-[#bcff83] text-white bg-black hover:bg-[#bcff83] hover:text-black transition-colors font-nunito font-semibold rounded-lg text-sm sm:text-base">
                View All
              </button>
              <button className="px-6 sm:px-8 py-2 sm:py-3 border-2 border-[#bcff83] text-white bg-black hover:bg-[#bcff83] hover:text-black transition-colors font-nunito font-semibold rounded-lg text-sm sm:text-base">
                Inquire
