...
export default function CategoryCard({ title, imageSrc, to = "#", className }: Props) {
  return (
    <Link
      href={to}
      className={cn(
    ...
    >
      ...
      >
        ...
        <div className="absolute left-6 bottom-6">
          <span
            className={cn(
              "inline-flex items-center rounded-full px-4 py-2 text-base md:text-lg font-semibold whitespace-nowrap",
