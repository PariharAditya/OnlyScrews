...
export default function AllenScrewsPage() {
  const allenScrews = [
    ...
    { title: "Allen Flange Button Head", slug: "allen-flange-button-head-machine-screws", image: "/images/products/screws/machine screws/allen screws/Flange button head.png" },
