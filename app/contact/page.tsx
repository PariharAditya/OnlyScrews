      ...
      <div className="container mx-auto px-4 pt-32 pb-12">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <p className="text-lg text-gray-700 mb-8">
            Have any doubts, comments, or just like to say Hi, we are here for
            you, and we are wearing our thinking caps!
          </p>
          ...
          <div className="space-y-4 mb-8">
            <p className="text-xl">
              <a
                ...
                className="text-[#1a5f7a] hover:underline font-semibold"
              >
                +91-9876543210
              </a>
            ...
            <p className="text-gray-700">
              ...
              <a
                href="mailto:info@screwbazar.com"
          ...
          <div className="bg-gray-50 p-6 rounded-lg text-left">
            ...
            <div className="space-y-2 text-gray-800">
              <p>
                ...
                <a
                  href="mailto:founder@screwbazar.com"
                  className="text-[#1a5f7a] hover:underline"
                >
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="font-sans text-gray-600">
                We typically process and ship orders within 24-48 hours.
                Delivery time depends on your location and can take 2-5 business
                days within India.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="font-sans text-gray-600">
                Yes, we offer competitive bulk pricing for large orders. Please
                contact our sales team with your requirements for a custom
                quote.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="font-sans text-gray-600">
                ...
                and other standard payment options. For bulk orders, we can
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-heading text-xl font-semibold mb-3">
                Do you provide technical specifications?
              </h3>
              <p className="font-sans text-gray-600">
                Yes, we provide detailed technical specifications for all our
                products. You can find these on individual product pages or
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="font-sans text-gray-600">
                ...
                in original packaging. Please contact our customer service team
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="font-sans text-sm">
                Your trusted partner for industrial fasteners and hardware
                solutions.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 font-sans">
                <li>
                  <Link
                    href="/"
                    className="hover:text-[#1a5f7a] transition-colors"
                  >
                    Home
                  </Link>
                </li>
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 text-center text-gray-600">
            ...
            <p className="font-sans">
              &copy; {new Date().getFullYear()} Screw Bazar. All rights
              reserved.
            </p>
          </div>
        </div>
