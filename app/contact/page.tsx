        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-xl font-semibold mb-3">What are your delivery timelines?</h3>
              <p className="text-gray-600">We typically process and ship orders within 24-48 hours. Delivery time depends on your location and can take 2-5 business days within India.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-xl font-semibold mb-3">Do you offer bulk pricing?</h3>
              <p className="text-gray-600">Yes, we offer competitive bulk pricing for large orders. Please contact our sales team with your requirements for a custom quote.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-xl font-semibold mb-3">What payment methods do you accept?</h3>
              <p className="text-gray-600">We accept various payment methods including bank transfers, UPI, and other standard payment options. For bulk orders, we can discuss payment terms.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-xl font-semibold mb-3">Do you provide technical specifications?</h3>
              <p className="text-gray-600">Yes, we provide detailed technical specifications for all our products. You can find these on individual product pages or contact our technical team for specific requirements.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-xl font-semibold mb-3">What is your return policy?</h3>
              <p className="text-gray-600">We accept returns within 7 days of delivery for unused products in original packaging. Please contact our customer service team to initiate a return.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              />
              <p className="text-sm">Your trusted partner for industrial fasteners and hardware solutions.</p>
            </div>
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 text-center text-gray-600">
            ...
            <p>&copy; {new Date().getFullYear()} Screw Bazar. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
