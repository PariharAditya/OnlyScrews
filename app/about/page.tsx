    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="bg-[#1a5f7a] text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="font-heading text-4xl md:text-5xl font-bold mb-6">About OnlyScrews</h1>
          <p className="font-sans text-xl text-gray-100 max-w-3xl">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-[#1a5f7a]">Our Mission</h2>
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-[#1a5f7a]">Our Vision</h2>
            <p className="font-sans text-lg text-gray-600">
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="font-heading text-3xl font-bold text-center text-[#1a5f7a] mb-12">Why Choose OnlyScrews</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="font-heading text-xl font-semibold text-[#1a5f7a] mb-4">Quality Assurance</h3>
              <p className="font-sans text-gray-600">
                All our products undergo rigorous quality control and meet international standards for strength and durability.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="font-heading text-xl font-semibold text-[#1a5f7a] mb-4">Expert Support</h3>
              <p className="font-sans text-gray-600">
                Our technical team provides expert guidance to help you choose the right fastening solutions for your applications.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="font-heading text-xl font-semibold text-[#1a5f7a] mb-4">Fast Delivery</h3>
              <p className="font-sans text-gray-600">
      ...
      {/* Our Values */}
      <div className="container mx-auto px-4 py-16">
        <h2 className="font-heading text-3xl font-bold text-center text-[#1a5f7a] mb-12">Our Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={value.title} className="text-center space-y-4">
              <h3 className="font-heading text-xl font-semibold text-[#1a5f7a]">{value.title}</h3>
