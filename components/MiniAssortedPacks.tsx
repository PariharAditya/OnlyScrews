        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-[2000px] mx-auto">
          {products.map((product) => (
            ...
            >
              ...
              <h3 className="text-sm font-medium text-gray-200 mb-2 line-clamp-2 h-10">
                {product.name}
              </h3>
