...
export const screwsData = {
  ...
  "pan-sem": {
    ...
    about: "Pan Head SEMS Screws feature a pre-assembled captive washer that cannot be removed, combining screw and washer into a single component. This design saves assembly time, ensures the washer is always present, and distributes load more evenly.",
    specifications: [
      { label: "Type", value: "SEMS (Screw and Washer Assembly)" },
      { label: "Head Type", value: "Pan Head" },
      { label: "Washer", value: "Pre-assembled Captive" },
      { label: "Assembly", value: "Single Component" },
      { label: "Material Grade", value: "High Quality" },
      { label: "Application", value: "High-Volume Assembly" },
    ],
  },
  ...
  "hex-sem": {
    ...
    about: "Hex Head SEMS Screws combine the efficiency of pre-assembled washers with the high-torque capability of hex head design. The captive washer ensures consistent load distribution while the hex head allows installation with standard wrenches or sockets.",
    specifications: [
      { label: "Type", value: "SEMS (Screw and Washer Assembly)" },
      ...
      { label: "Application", value: "Structural, Automotive" },
    ],
  },

  "philip-machine-screws": {
    title: "Philip Machine Screws | Phillips Drive | Cross Recess | High Tensile | Fully Threaded | Multiple Materials Available",
    images: [
      "/images/products/screws/machine screws/Phillips Machine Screw.png",
      "/images/products/screws/machine screws/Phillips Machine Screw.png",
      "/images/products/screws/machine screws/Phillips Machine Screw.png",
    ],
    materials: [
    ...
    about: "Philip Machine Screws feature the classic Phillips cross-recess drive design, providing reliable fastening with excellent torque transfer. The cross-shaped recess allows for positive engagement with Phillips screwdrivers. Ideal for general-purpose applications, electronics assembly, and furniture manufacturing.",
    specifications: [
      { label: "Head Type", value: "Pan/Flat/Round Head" },
      ...
      { label: "Application", value: "General Purpose Assembly" },
      { label: "Standard", value: "DIN 965, ISO 7045" },
    ],
  },

  "slotted-machine-screws": {
    title: "Slotted Machine Screws | Flat Slot Drive | Traditional Design | High Tensile | Fully Threaded | Multiple Materials",
    images: [
      "/images/products/screws/machine screws/Slotted Machine Screw.png",
      "/images/products/screws/machine screws/Slotted Machine Screw.png",
      "/images/products/screws/machine screws/Slotted Machine Screw.png",
    ],
    materials: [
    ...
    about: "Slotted Machine Screws feature the traditional single-slot drive design, offering simplicity and universal compatibility with flat-blade screwdrivers. Perfect for vintage restorations, electrical equipment, and applications where a classic appearance is desired.",
    specifications: [
      { label: "Head Type", value: "Pan/Flat/Round Head" },
      { label: "Drive Type", value: "Slotted (Flat Blade)" },
      { label: "Thread Coverage", value: "Fully Threaded" },
      { label: "Material Grade", value: "High Tensile" },
      { label: "Application", value: "General Purpose, Electrical" },
      { label: "Standard", value: "DIN 963, ISO 2009" },
    ],
  },
  ...
  "pan-torx-sts": {
    ...
    about: "Pan Head Torx Self-Tapping Screws create their own threads as they're driven into materials, eliminating the need for pre-tapping. The Torx drive provides superior torque transfer and reduced cam-out.",
    specifications: [
  ...
  "csk-torx-sts": {
    ...
    about: "Countersunk Torx Self-Tapping Screws combine the flush-mounting benefits of a countersunk head with self-tapping capability and superior Torx drive performance. Ideal for sheet metal work and electronics enclosures.",
    specifications: [
      { label: "Type", value: "Self-Tapping (STS)" },
      ...
      { label: "Thread Forming", value: "Self-Tapping" },
      { label: "Application", value: "Sheet Metal, Electronics" },
    ],
  },
  ...
  "csk-sds": {
    ...
    specifications: [
      ...
      { label: "Application", value: "Panels, Automotive, Cabinetry" },
    ],
  },
  ...
  "water-head-sds": {
    ...
    about: "Wafer Head Self-Drilling Screws feature an extra-wide, low-profile head that provides a large bearing surface for better load distribution on thin sheet metal. Ideal for metal roofing, siding, and HVAC ductwork.",
    specifications: [
      { label: "Type", value: "Self-Drilling Screw" },
      { label: "Head Type", value: "Wafer Head (Wide)" },
      { label: "Bearing Surface", value: "Extra Large" },
      { label: "Point Type", value: "Drill Point (Tek)" },
      { label: "Drive Type", value: "Phillips, Torx" },
