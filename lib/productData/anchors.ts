...
export const anchorsData = {
  ...
  "chemical-anchor": {
    title: "Chemical Anchor | Resin Anchor | Epoxy System | High Load | Cracked Concrete | Multiple Systems",
    images: [
      "/images/products/anchors/CHEMICAL ANCHOR.png",
      "/images/products/anchors/CHEMICAL ANCHOR.png",
      "/images/products/anchors/CHEMICAL ANCHOR.png",
    ],
    materials: [
      { id: 1, name: "Epoxy Resin", color: "from-amber-300 to-orange-400", image: "https://images.unsplash.com/photo-1504907762671-07cfb4351d39?w=600&h=400&fit=crop" },
      { id: 2, name: "Polyester Resin", color: "from-yellow-300 to-amber-400", image: "https://images.unsplash.com/photo-1504907762671-07cfb4351d39?w=600&h=400&fit=crop" },
      { id: 3, name: "Vinylester Resin", color: "from-orange-300 to-red-400", image: "https://images.unsplash.com/photo-1504907762671-07cfb4351d39?w=600&h=400&fit=crop" },
    ],
    about: "Chemical Anchors use two-part resin systems (epoxy, polyester, or vinylester) to bond threaded rods and rebar into concrete. Provides highest load capacity, works in cracked concrete, and offers versatile positioning.",
    specifications: [
      { label: "Type", value: "Chemical/Resin Anchor" },
      { label: "System", value: "Epoxy, Polyester, Vinylester" },
      { label: "Installation", value: "Inject Resin, Insert Rod" },
      { label: "Base Material", value: "Concrete (Cracked/Uncracked)" },
      { label: "Load Capacity", value: "Very High" },
      { label: "Application", value: "Structural, Seismic, Heavy Load" },
    ],
  },

  "rawl-plug": {
    title: "Rawl Plug | Wall Plug | Plastic Anchor | Light Duty | Screw Expansion | Multiple Sizes",
    images: [
      "/images/products/anchors/RAWL PLUG.png",
      "/images/products/anchors/RAWL PLUG.png",
      "/images/products/anchors/RAWL PLUG.png",
    ],
    materials: [
      ...
      { id: 2, name: "Polypropylene", color: "from-blue-200 to-cyan-300", image: "https://images.unsplash.com/photo-1578500494198-246f612d03b3?w=600&h=400&fit=crop" },
      { id: 3, name: "High-Density PE", color: "from-gray-200 to-slate-300", image: "https://images.unsplash.com/photo-1504907762671-07cfb4351d39?w=600&h=400&fit=crop" },
    ],
    about: "Rawl Plugs (Wall Plugs or Plastic Anchors) are plastic inserts that expand when screws are driven, creating secure anchoring in brick, block, and concrete for light to medium-duty applications.",
    specifications: [
      { label: "Type", value: "Plastic Expansion Plug" },
      { label: "Material", value: "Nylon, Polypropylene, PE" },
      { label: "Installation", value: "Insert, Drive Screw" },
      { label: "Base Material", value: "Brick, Block, Concrete, Drywall" },
      { label: "Load Capacity", value: "Light to Medium Duty" },
      { label: "Application", value: "General Mounting, Fixtures" },
    ],
  },

  "toggle-bolt": {
    title: "Toggle Bolt | Butterfly Anchor | Hollow Wall Anchor | High Load | Drywall | Multiple Sizes",
    images: [
      "/images/products/anchors/TOGGLE BOLT.png",
      "/images/products/anchors/TOGGLE BOLT.png",
      "/images/products/anchors/TOGGLE BOLT.png",
    ],
    materials: [
    ...
    about: "Toggle Bolts feature spring-loaded wings that open behind hollow walls, distributing load over a large area. Provides the highest holding power in drywall and hollow walls for heavy fixtures and cabinets.",
    specifications: [
      { label: "Type", value: "Toggle/Butterfly Anchor" },
      { label: "Mechanism", value: "Spring-Loaded Wings" },
      { label: "Installation", value: "Insert Folded, Opens Behind Wall" },
      { label: "Base Material", value: "Drywall, Hollow Walls, Plaster" },
      { label: "Load Capacity", value: "High (Up to 100+ lbs)" },
      { label: "Application", value: "Cabinets, Shelves, Heavy Fixtures" },
    ],
  },
